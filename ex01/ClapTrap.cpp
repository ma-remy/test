...
ClapTrap::ClapTrap(const std::string &Name, const int EnergiePts, const int HitPts, const int AttackDmg)
    : _Name(Name), _EnergiePoints(EnergiePts), _HitPoints(HitPts), _AttackDamage(AttackDmg)
{
